  ...
  <body>
        ...
        <div class="container container-pad  pad-t-13">
          <div class="navigation__left">
                        <ul class="menu menu--furniture">
                          ...
                          <li class="current-menu-item "><a href="homepage-2.html">Blood Pressure</a>
                          </li>
                          <li class="current-menu-item menu-item-has-children"><a href="index.html">Classification</a><span class="sub-toggle"></span>
                                        <ul class="sub-menu">
                                          <li><a href="index.html">List 1</a>
                                          </li>
                                          <li><a href="homepage-2.html">List 2</a>
                                          </li>
                                          <li><a href="homepage-10.html">List 3</a>
                                          </li>
                                        </ul>
                          </li>

                          <li class="current-menu-item "><a href="homepage-2.html">Remedies</a>
                          </li>
                          <li class="current-menu-item "><a href="homepage-2.html">Treatment</a>
                          </li>
                        </ul>
          </div>
    ...
    <div id="homepage-2">
      <div class="ps-home-banner">
        <div class="ps-carousel--nav-inside owl-slider " data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="true" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on" data-owl-animate-in="fadeIn" data-owl-animate-out="fadeOut">          
          <div class="ps-banner--furniture ps-banner--furniture-mob" >
           <img class="slider-height" src="{{asset('assets/front/img/doc-3.jpg')}}" alt="">
            <div class="ps-banner__content">
              <h4 >Version 2018</h4>
              <h3 >USE OUR QUICK CHECK TO <br>GET FASTER RESULTS</h3>
              <p >New version 2018 with many powerful features.</p>
              <p ><strong>Faster, Friction better & Cheap Price</strong></p><a class="ps-btn point-area" href="#">CHECK NOW</a>
            </div>            
          </div>
          <div class="ps-banner--furniture ps-banner--furniture-mob">
            <img class="slider-height" src="{{asset('assets/front/img/doc-4.jpg')}}" alt="">
            <div class="ps-banner__content">
              <h4>Version 2018</h4>
          ...
          <div class="align-content-lg-stretch" >
            <div class="press-cal">
                <div class="press-cal-img" >
                  <img height="100%" src="{{asset('assets/front/img/doc-1.jpg')}}">
                </div>
                    ...
                    <form>
                      <div class="press-cal-form">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-4">
                            <input type="number"  class="form-control-cus" >
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <button class="ps-btn" style="width: 100%;background: black">Check Now</button>
                      </div>
                    </form>
      ...
      <div class="ps-promotion ps-promotion--2">
        <div class=""><a class="ps-collection" href="#"><img src="{{asset('assets/front/img/promotions/home-2-3.jpg')}}" alt=""></a></div>
      </div>
      <div class="container container-pad"  >
        <div class="row row-about" >
          ...
          <div class="col-sm-6">
            <img src="{{asset('assets/front/img/doc-2.jpg')}}">
          </div>
        </div>
      </div>
          ...
          <div class="ps-section__content" style="padding: 8px;">
            <div class="row">
              <div class="ps-carousel--nav owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000" data-owl-gap="0" data-owl-nav="false" data-owl-dots="true" data-owl-item="3" data-owl-item-xs="2" data-owl-item-sm="3" data-owl-item-md="3" data-owl-item-lg="3" data-owl-duration="1000" data-owl-mousedrag="on">
                <div class="pad-10" >
                  <div class="ps-post">
                    <div class="ps-post__thumbnail"><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{asset('assets/front/img/blog/organic/1.jpg')}}" alt=""></div>
                    <div class="ps-post__content"><a class="ps-post__title" href="#">How To Make A Fresh Juice Blended For Your Family?</a>
                      <p>Praesent adipiscing. In auctor lobortis lacus. Donec mollis hendrerit risus.Maecenas nec odio et ante tincidunt tempus. Sed magna purus, fermentum eu, tincidunt eu, varius ut, felis. Phasellus dolor.</p>
                    </div>
                  </div>
                </div>
                <div class="pad-10">
                  <div class="ps-post">
                    <div class="ps-post__thumbnail">
                      <div class="ps-post__badge"><i class="icon-volume-high"></i></div><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{asset('assets/front/img/blog/organic/2.jpg')}}" alt="">
                    </div>
                    <div class="ps-post__content"><a class="ps-post__title" href="#">Fresh Eggs From Caroline’s Farm</a>
                      <p>Praesent adipiscing. In auctor lobortis lacus. Donec mollis hendrerit risus.Maecenas nec odio et ante tincidunt tempus. Sed magna purus, fermentum eu, tincidunt eu, varius ut, felis. Phasellus dolor.</p>
                    </div>
                  </div>
                </div>
                <div class="pad-10">
                  <div class="ps-post">
                    <div class="ps-post__thumbnail">
                      ...
                      <div class="ps-post__badge"><i class="icon-volume-high"></i></div><a class="ps-post__overlay" href="blog-detail.html"></a><img src="{{asset('assets/front/img/blog/organic/3.jpg')}}" alt="">
                    </div>
                    <div class="ps-post__content"><a class="ps-post__title" href="#">Discover Fresh Organic Farms In Switzeland Villages</a>
                      <p>Praesent adipiscing. In auctor lobortis lacus. Donec mollis hendrerit risus.Maecenas nec odio et ante tincidunt tempus. Sed magna purus, fermentum eu, tincidunt eu, varius ut, felis. Phasellus dolor.</p>
    ...
    <footer class="ps-footer ps-footer--2">
          <div class="container container-pad" >
            <nav class="navigation-cus">              
                <ul class="menu-cus">
                  ...
                  <li class="current-menu-item "><a href="homepage-2.html">Classification</a>
                  </li>
                  <li class="current-menu-item "><a href="homepage-2.html">Remedies</a>
                  </li>
                  <li class="current-menu-item "><a href="homepage-2.html">Treatment</a>
                  </li>
                  <li class="current-menu-item "><a href="homepage-2.html">About Us</a>
                  </li>
                  <li class="current-menu-item "><a href="homepage-2.html">Privacy Policy</a>
                  </li>
      ...
      <div class="ps-vendor-banner bg--cover" data-background="{{asset('assets/front/img/bg/vendor.jpg')}}" style="background: url(&quot;img/bg/vendor.jpg&quot;);">
        <div class="container">
