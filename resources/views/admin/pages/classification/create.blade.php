    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">Add Classification Page</span>
                <div class="btn-group">
        ...
        <div class="portlet-body form">
            ...
            <form id="geniusform" action="{{route('admin-pgclass-store')}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            {{csrf_field()}}
