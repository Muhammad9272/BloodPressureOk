    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">Edit Blood Pressure Page</span>

               

                                                <div class="btn-group">
                                                    <a id="sample_editable_1_new" class="btn sbold green" href="{{route('admin-pgblood-index')}}"> <i class="fa fa-arrow-left"></i>&nbsp;Back
        ...
        <div class="portlet-body form">
            ...
            <form id="geniusform" action="{{route('admin-pgblood-update',$data->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            {{csrf_field()}}
