    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">Edit Page</span>
        ...
        <div class="portlet-body form">
            ...
            <form id="geniusform" action="{{route('admin-pgother-update',$data->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            {{csrf_field()}}
               @include('includes.admin.form-both')
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label">Dispaly on Footer</label>
                        <div class="col-md-6">
                            <div class="clearfix">
