    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">Edit Calculations</span>
        ...
        <div class="portlet-body form">
            ...
            <form id="geniusform" action="{{route('admin-bcl-update',$data->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            {{csrf_field()}}
