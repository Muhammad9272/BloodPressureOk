                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-3 d-inline-flex">
                            <input type="number" class="form-control"  name="upper1" required="">  

                            <label class="col-md-3 control-label" >TO</label>

                              <input type="number" class="form-control"  name="upper2" required="">                           
                        </div>                        
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label" >Lower value</label>
                        <div class="col-md-3 d-inline-flex">
                            <input type="number" class="form-control"  name="lower1" required="">  

                            <label class="col-md-3 control-label" >TO</label>

                              <input type="number" class="form-control"  name="lower2" required="">                           
                        </div>                        
                    </div>
