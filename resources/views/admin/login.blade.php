...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('assets/admin_assets/pages/css/login.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        <!-- BEGIN LOGO -->
        <div class="logo">
              <a  href="{{url('/')}}"><img style="" src="{{asset('assets/admin_assets/adlogo.png')}}" alt="logo" ></a>
        </div>
        <!-- END LOGO -->
            ...
            <!-- BEGIN LOGIN FORM -->
             ...
             <form method="POST" action="{{ route('admin.login.submit') }}" id="loginform">
                ...
                <div class="form-actions">
                   ...
                   {{--  <a href="{{ route('admin.forgot') }}" id="forget-password" class="forget-password">Forgot Password?</a> --}}
                </div>
        ...
        <div class="copyright"> 2020 © All Rights Reseverd by BloodPressureCalculator.com </div>
        <!--[if lt IE 9]>
