    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">Edit slider</span>
        ...
        <div class="portlet-body form">
            ...
            <form id="geniusform" action="{{route('admin-sl-update',$data->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            {{csrf_field()}}
                        ...
                        <div class="col-md-7">
                                <div class="form-file">
                                    ...
                                    <label for="your_picture">
                                        <figure>
                                            <img src="{{asset('assets/images/sliders/'.$data->photo)}}" alt="" class="your_picture_image">
                                        </figure>
