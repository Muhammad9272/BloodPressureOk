               ...
               @include('includes.admin.form-both')
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                                <div class="form-file">
                                    <input type="file" class="inputfile" name="photo" id="your_picture"  onchange="readURL(this);" data-multiple-caption="{count} files selected" multiple required="" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 d-inline-flex">
                            <input style="height: 70px;" type="text" class="form-control"  name="small_desc" required="" >  
                    ...
                    <div class="row">
                        ...
                        <div class="form-group last">
                            <label class="control-label col-md-3">Article Detail</label>
                            <div class="col-md-8">
